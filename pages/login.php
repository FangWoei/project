  ...
  //make sure if the user wasn't logged in yet.
    ...
    if ( $_SERVER["REQUEST_METHOD"] === 'POST') {
      ...
      if ( !$error ) {
        ...
        //Step 4: remove csrf token & redirect the user to dashboardd
...
<div class="three">
  <div class="container" style="max-width: 500px;">
    <h1 class="h1 mb-4 text-center py-5">Login</h1>
  ...
  >Don't have an account? Come here
